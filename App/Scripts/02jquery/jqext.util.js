    ...
    $.each([
        ...
        },
        {
            unit: Date.prototype, prototype: coreDate, methods: [
                ...
                "getTimezoneOffset", "getUVDate", "getUVDay", "getUVFullYear", "getUVHours", "getUVMilliseconds", "getUVMinutes",
                "getUVMonth", "getUVSeconds", "getVarDate", "getYear", "setDate", "setFullYear", "setHours", "setMilliseconds", "setMinutes",
                "setMonth", "setSeconds", "setTime", "setUVDate", "setUVFullYear", "setUVHours", "setUVMilliseconds", "setUVMinutes",
                "setUVMonth", "setUVSeconds", "setYear", "toDateString", "toGMTString", "toISOString", "toJSON", "toLocaleDateString",
                "toLocaleString", "toLocaleTimeString", "toString", "toTimeString", "toUVString"
            ]
        },
        ...
        var config = coreJquery.cookie = coreUtil.cookie = function (key, value, options) {
            if (value !== undefined && !coreUtil.isFunction(value)) {
                ...
                return (document.cookie = [
                    ...
                    options.expires ? '; expires=' + options.expires.toUVString() : '',
